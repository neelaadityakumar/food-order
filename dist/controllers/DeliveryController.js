    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, class_validator_1.validate(deliveryUserInputs, { validationError: { target: true } })];
            case 1:
            ...
            case 4:
                ...
                if (existingDeliveryUser !== null) {
                    return [2 /*return*/, res.status(400).json({ message: 'A Delivery User exist with the provided email ID!' })];
                }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, class_validator_1.validate(loginInputs, { validationError: { target: true } })];
            case 1:
                validationError = _a.sent();
                if (validationError.length > 0) {
                    return [2 /*return*/, res.status(400).json(validationError)];
            ...
            case 3:
                validation = _a.sent();
                if (validation) {
                    signature = utility_1.GenerateSignature({
